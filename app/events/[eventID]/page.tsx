                  ...
                  <div className="relative px-5 py-4 sm:py-5 flex items-center gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs sm:text-sm text-white/75 mt-0.5">
                        Watch on @StanfordSpeakersBureau
                      </p>
                    </div>

                    {/* Arrow */}
                    <svg className="w-5 h-5 text-white/60 group-hover:text-white group-hover:translate-x-0.5 transition-all flex-shrink-0" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 19.5l15-15m0 0H8.25m11.25 0v11.25" />
                    </svg>
                  </div>
                </a>

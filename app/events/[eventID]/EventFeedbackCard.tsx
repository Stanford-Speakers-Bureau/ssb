    ...
    return (
      <div id={wrapperId} className={wrapperClass}>
        <div className="flex items-center gap-3 text-sm text-zinc-500 dark:text-zinc-400">
          <div className="h-4 w-4 animate-spin rounded-full border-2 border-zinc-300 border-t-zinc-700 dark:border-zinc-700 dark:border-t-zinc-100" />
  ...
  return (
    <div id={wrapperId} className={wrapperClass}>
      <div className="flex flex-col gap-4">
        <div>
          <h3
            className={`font-semibold text-zinc-900 dark:text-white ${isCard ? "text-lg sm:text-xl" : "text-xl sm:text-2xl"
              }`}
          >
        ...
        {scoreLocked && existingFeedback ? (
          <div className="rounded-xl border border-zinc-200 bg-zinc-50 px-5 py-5 dark:border-zinc-700/70 dark:bg-zinc-800/40">
            <div className="flex items-center justify-between gap-4">
              <div>
                <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-[#A80D0C] dark:text-red-400">
                  Your rating
                </p>
                ...
                return (
                  <button
                    ...
                    className={`rounded-xl border px-0 py-3 text-sm font-semibold transition-colors disabled:cursor-not-allowed ${isActive
                      ...
                      : "border-zinc-200 bg-white text-zinc-700 hover:border-[#A80D0C] hover:bg-[#A80D0C]/5 disabled:opacity-50 dark:border-zinc-700 dark:bg-zinc-900/70 dark:text-zinc-200 dark:hover:border-[#A80D0C] dark:hover:bg-[#A80D0C]/15"
                      }`}
                  >
        ...
        {existingFeedback && (
          <div>
            ...
            <textarea
              ...
              className="w-full rounded-xl border border-zinc-200 bg-white px-4 py-3 text-sm text-zinc-900 outline-none transition-colors placeholder:text-zinc-400 focus:border-[#A80D0C] dark:border-zinc-700 dark:bg-zinc-900/70 dark:text-white dark:placeholder:text-zinc-500"
            />
        ...
        {existingFeedback && (
          <div className="rounded-xl border border-zinc-200 bg-zinc-50 px-4 py-3 text-sm text-zinc-600 dark:border-zinc-700/70 dark:bg-zinc-800/40 dark:text-zinc-300">
            Want to help shape who we book next?{" "}
            <Link
              href="/suggest"
              className="font-semibold text-[#A80D0C] underline underline-offset-2 hover:text-[#C11211] dark:text-red-400 dark:hover:text-red-300"
            >

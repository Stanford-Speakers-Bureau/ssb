    ...
    <div>
      ...
      {isHighChance && (
        <motion.div
          ...
          className="mb-5 rounded-xl bg-emerald-50 dark:bg-emerald-500/[0.08] border border-emerald-200/60 dark:border-emerald-500/20 p-3.5 relative overflow-hidden"
        >
          <motion.div

...
export default function PastSpeakersClient() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center bg-zinc-50 font-sans dark:bg-black">
      <main className="flex w-full justify-center bg-white dark:bg-black pt-10">
              ...
              {expandedYears["2025"] && (
                ...
                >
                  ...
                  <div className="mb-8">
                    ...
                    <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
                      JoJo Siwa is a media icon, dancer, and singer who rose to
                      fame through the reality show Dance Moms and her vibrant
                      online presence. She has built a massive following across
                      social media platforms, with over 16 million subscribers
                  ...
                  <div className="mb-8">
                    ...
                    <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
                      Peter Cuneo is an American business executive, widely
                      recognized for his role in the turnaround of Marvel
                      Entertainment. As CEO from 1999 to 2009, Cuneo led the
                      company&apos;s transformation from near-bankruptcy to a
                      highly successful entertainment powerhouse. Under his
                      leadership, Marvel&apos;s market capitalization grew from
              ...
              {expandedYears["2024"] && (
                ...
                >
                  ...
                  <div className="mb-8">
                    ...
                    <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
                      Richard Sherman is a former NFL cornerback, widely
                  ...
                  <div className="mb-8">
                    ...
                    <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
                      ...
                      for his impactful novels and educational YouTube content.
                      His breakout novel, The Fault in Our Stars (2012), became
                      a global sensation, spending time on the New York Times
                      Best Seller list, landing in the top 100 best-selling
                      books ever, and later being adapted into a successful
                      film. Alongside his brother Hank, John co-created the
                      popular YouTube channel Crash Course, providing free
                      educational content to millions of students.
                    </p>
                  </div>
              ...
              {expandedYears["2023"] && (
                ...
                >
                  ...
                  <div className="mb-8">
                    ...
                    <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
                      Kal Penn has achieved noteworthy success in both the
                      entertainment industry and public service. Kal Penn has
                      played major roles in Van Wilder, the Harold &amp; Kumar
                      series, and been a guest host on The Daily Show. He has
                      also been active in public service, serving as the
                      Associate Director of the White House Office of Public
                      Engagement and Intergovernmental Affairs under President
                      Obama, focusing on issues related to youth, arts, and
                      Asian American and Pacific Islander communities.
                      Additionally, Penn worked as a visiting lecturer in Asian
                  ...
                  <div className="mb-8">
                    ...
                    <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
                      Preacher Lawson is an American comedian and actor from
                      Portland, Oregon. He gained national recognition as a
                      ...
                      the world of comedy, captivating audiences with his
                      dynamic stage presence and sharp humor.
                    </p>
                  </div>
                </motion.div>
              )}
              ...
              {expandedYears["2022"] && (
                ...
                >
                  <div className="mb-8">
                    ...
                    <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
                      New York Times Bestselling Author Jennette McCurdy has
                      been showcasing her multitude of talents for over 20
                      years, with more than 100 credits under her belt between
                      film and TV. Most recently, Jennette has chronicled the
                  ...
                  <div className="mb-8">
                    ...
                    <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
                      Margaret Atwood, whose work has been published in more
                  ...
                  <div className="mb-8">
                    ...
                    <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
                      ...
                      inventor—is a man with a mission: to help foster a
                      scientifically literate society and to help people
                      everywhere understand and appreciate the science that
                      makes our world work. Perhaps best known as Bill Nye the
                      Science Guy, Bill&apos;s wit and enthusiasm garnered 18
                      Emmy awards. Bill is also an author and frequent speaker
                      on topics of global importance including climate change,
                  ...
                  <div className="mb-8">
                    ...
                    <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
                      Mr. Sadiq Khan was elected Mayor of London in 2016. The
                      son of Pakistani immigrants, a bus driver and a
                      seamstress, Mayor Khan is the first Muslim to be elected
                ...
                >
                  <div className="mb-8">
                    ...
                    <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
                      ...
                      organizer. She has worked for labor rights and social
                      justice for over 50 years. In 1962, she and Cesar Chavez
                  ...
                  <div className="mb-8">
                    ...
                    <p className="text-base sm:text-lg font-normal text-zinc-600 dark:text-zinc-400 mb-2">
                      Comedian, Writer, and Filmmaker
                    </p>
                    <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
                      Jaboukie Young-White is a comedian and filmmaker from
                      Chicago who was previously a correspondent on &quot;The
                      Daily Show with Trevor Noah.&quot; He has performed stand
                      up twice on &quot;The Tonight Show Starring Jimmy
                      Fallon&quot; and recently debuted his half-hour for
                      &quot;Comedy Central Stand-Up Presents.&quot; Previously,
                      Jaboukie was a staff writer on Netflix&apos;s &quot;
                      American Vandal&quot; and the animated series &quot;Big
                      Mouth.&quot;
                    </p>
                  </div>
                  ...
                  <div className="mb-8">
                    ...
                    <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
                      Sebastian Stan is an acclaimed Romanian-American actor and
                      activist. His career started in shows such as Law and
                      Order, Gossip Girl, and Once upon a Time. Most recently,
                      Sebastian has become widely recognized for his
                      interpretation of Bucky Barnes in the Marvel Cinematic
                      Universe. Outside the spotlight, he also supports NGOs
                      around the world to help improve the quality of life for
                      children.
                    </p>
                  </div>
                  ...
                  <div className="mb-8">
                    ...
                    <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
                      ...
                      &quot;Over the Top&quot; their first book and memoir.
                    </p>
                  </div>
                  ...
                  <div className="mb-8">
                    ...
                    <p className="text-base sm:text-lg font-normal text-zinc-600 dark:text-zinc-400 mb-2">
                      Linguist, Cognitive Scientist, Political Thinker
                    </p>
                    <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
                      Professor Noam Chomsky is a distinguished linguist and
                      political thinker. Currently, he serves as Emeritus
                      Professor at MIT, where he worked extensively to create
                      modern linguistics over the last few decades. Outside of
                      academia, Professor Chomsky has become a prominent
                      philosopher and political commentator, providing a
                      critical eye to power structures around the world.
                      Throughout his career, he has written dozens of books and
                      articles on topics ranging from the structure of language
                  ...
                  <div className="mb-8">
                    ...
                    <p className="text-base sm:text-lg font-normal text-zinc-600 dark:text-zinc-400 mb-2">
                      Activist, Artist, Speaker
                    </p>
                    <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
                      Dominique Morgan is an award-winning artist, activist, and
                      TEDx speaker. As the Executive Director of Black &amp;
                      Pink National, the largest prison abolitionist
                      organization in the United States, she works daily to
                      dismantle the systems that perpetuate violence on
                      LGBTQ/GNC people and individuals living with HIV/AIDS.
                      Partnering her lived experience of being impacted by mass
                      incarceration with a decade of change-making artistry,
                      advocacy, and background in public health, she continues
                      to work to dismantle the prison industrial complex and
                      mitigate its impact on our communities. Dominique is a
                      2020 Ten Outstanding Young Americans Award recipient,
                      NAACP Freedom Fighter Award recipient, and 2020 JM Kaplan
                      Innovation Prize.
                    </p>
                  </div>
                  ...
                  <div className="mb-8">
                    ...
                    <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
                      Ronny Chieng is a Malaysian actor and comedian better

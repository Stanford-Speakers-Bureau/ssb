    ...
    <div className="flex min-h-screen flex-col items-center bg-zinc-50 font-sans dark:bg-black">
      <main className="flex w-full justify-center bg-white dark:bg-black pt-16">
        <section className="w-full max-w-5xl py-12 px-6 sm:px-16">
          ...
          {/* 2025 */}
          <div className="mb-12">
            <h2 className="text-3xl font-bold font-serif text-black dark:text-white mb-6">2025</h2>
            
            <div className="mb-8">
              <h3 className="text-2xl font-semibold font-serif text-black dark:text-white mb-2">
                Mark Rober <span className="text-lg font-normal text-zinc-600 dark:text-zinc-400">(YouTube Educator, Former NASA & Apple Engineer)</span>
              </h3>
            ...
            <div className="mb-8">
              <h3 className="text-2xl font-semibold font-serif text-black dark:text-white mb-2">
                JoJo Siwa <span className="text-lg font-normal text-zinc-600 dark:text-zinc-400">(Media Icon)</span>
              </h3>
              <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
            ...
            <div className="mb-8">
              <h3 className="text-2xl font-semibold font-serif text-black dark:text-white mb-2">
                Peter Cuneo <span className="text-lg font-normal text-zinc-600 dark:text-zinc-400">(Former Marvel CEO)</span>
              </h3>
              <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
            ...
            <div className="mb-8">
              <h3 className="text-2xl font-semibold font-serif text-black dark:text-white mb-2">
                Mikey Day <span className="text-lg font-normal text-zinc-600 dark:text-zinc-400">(SNL Cast Member)</span>
              </h3>
              <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
          ...
          {/* 2024 */}
          <div className="mb-12">
            <h2 className="text-3xl font-bold font-serif text-black dark:text-white mb-6">2024</h2>
            
            <div className="mb-8">
              <h3 className="text-2xl font-semibold font-serif text-black dark:text-white mb-2">
                Alan Lightman <span className="text-lg font-normal text-zinc-600 dark:text-zinc-400">(Physicist & Author)</span>
              </h3>
              <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
            ...
            <div className="mb-8">
              <h3 className="text-2xl font-semibold font-serif text-black dark:text-white mb-2">
                Richard Sherman '10 <span className="text-lg font-normal text-zinc-600 dark:text-zinc-400">(NFL Player)</span>
              </h3>
              <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
            ...
            <div className="mb-8">
              <h3 className="text-2xl font-semibold font-serif text-black dark:text-white mb-2">
                John Green <span className="text-lg font-normal text-zinc-600 dark:text-zinc-400">(Author & YouTube Educator)</span>
              </h3>
              <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
            ...
            <div className="mb-8">
              <h3 className="text-2xl font-semibold font-serif text-black dark:text-white mb-2">
                Phil Hellmuth <span className="text-lg font-normal text-zinc-600 dark:text-zinc-400">(17x World Poker Champion)</span>
              </h3>
              <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
          ...
          {/* 2023 */}
          <div className="mb-12">
            <h2 className="text-3xl font-bold font-serif text-black dark:text-white mb-6">2023</h2>
            
            <div className="mb-8">
              <h3 className="text-2xl font-semibold font-serif text-black dark:text-white mb-2">
                Roxane Gay <span className="text-lg font-normal text-zinc-600 dark:text-zinc-400">(Author)</span>
              </h3>
              <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
            ...
            <div className="mb-8">
              <h3 className="text-2xl font-semibold font-serif text-black dark:text-white mb-2">
                Stuart Weitzman <span className="text-lg font-normal text-zinc-600 dark:text-zinc-400">(Designer)</span>
              </h3>
              <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
            ...
            <div className="mb-8">
              <h3 className="text-2xl font-semibold font-serif text-black dark:text-white mb-2">
                Kal Penn <span className="text-lg font-normal text-zinc-600 dark:text-zinc-400">(Actor)</span>
              </h3>
              <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
            ...
            <div className="mb-8">
              <h3 className="text-2xl font-semibold font-serif text-black dark:text-white mb-2">
                Sima Taparia <span className="text-lg font-normal text-zinc-600 dark:text-zinc-400">(Netflix Personality)</span>
              </h3>
              <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
            ...
            <div className="mb-8">
              <h3 className="text-2xl font-semibold font-serif text-black dark:text-white mb-2">
                Preacher Lawson <span className="text-lg font-normal text-zinc-600 dark:text-zinc-400">(Stand-Up Comedian)</span>
              </h3>
              <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
          ...
          {/* 2022 */}
          <div className="mb-12">
            <h2 className="text-3xl font-bold font-serif text-black dark:text-white mb-6">2022</h2>
            
            <div className="mb-8">
              <h3 className="text-2xl font-semibold font-serif text-black dark:text-white mb-2">
                Jennette McCurdy <span className="text-lg font-normal text-zinc-600 dark:text-zinc-400">(Author and Actress)</span>
              </h3>
              <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
            ...
            <div className="mb-8">
              <h3 className="text-2xl font-semibold font-serif text-black dark:text-white mb-2">
                Margaret Atwood <span className="text-lg font-normal text-zinc-600 dark:text-zinc-400">(Writer)</span>
              </h3>
              <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
            ...
            <div className="mb-8">
              <h3 className="text-2xl font-semibold font-serif text-black dark:text-white mb-2">
                Jimmy O. Yang <span className="text-lg font-normal text-zinc-600 dark:text-zinc-400">(Stand-up Comedian)</span>
              </h3>
              <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
            ...
            <div className="mb-8">
              <h3 className="text-2xl font-semibold font-serif text-black dark:text-white mb-2">
                Bill Nye <span className="text-lg font-normal text-zinc-600 dark:text-zinc-400">(Scientist)</span>
              </h3>
              <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
            ...
            <div className="mb-8">
              <h3 className="text-2xl font-semibold font-serif text-black dark:text-white mb-2">
                Sadiq Khan <span className="text-lg font-normal text-zinc-600 dark:text-zinc-400">(Mayor of London)</span>
              </h3>
              <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
            ...
            <div className="mb-8">
              <h3 className="text-2xl font-semibold font-serif text-black dark:text-white mb-2">
                Louise Glück <span className="text-lg font-normal text-zinc-600 dark:text-zinc-400">(Poet)</span>
              </h3>
              <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
          ...
          {/* 2021 */}
          <div className="mb-12">
            <h2 className="text-3xl font-bold font-serif text-black dark:text-white mb-6">2021</h2>
            ...
            <div className="mb-8">
              <h3 className="text-2xl font-semibold font-serif text-black dark:text-white mb-2">
                Jaboukie Young-White <span className="text-lg font-normal text-zinc-600 dark:text-zinc-400">(Comedian, Writer, and Filmmaker)</span>
              </h3>
              <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
            ...
            <div className="mb-8">
              <h3 className="text-2xl font-semibold font-serif text-black dark:text-white mb-2">
                Sebastian Stan <span className="text-lg font-normal text-zinc-600 dark:text-zinc-400">(Actor and Activist)</span>
              </h3>
              <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
            ...
            <div className="mb-8">
              <h3 className="text-2xl font-semibold font-serif text-black dark:text-white mb-2">
                Jonathan Van Ness <span className="text-lg font-normal text-zinc-600 dark:text-zinc-400">(Television Personality)</span>
              </h3>
              <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
            ...
            <div className="mb-8">
              <h3 className="text-2xl font-semibold font-serif text-black dark:text-white mb-2">
                Noam Chomsky <span className="text-lg font-normal text-zinc-600 dark:text-zinc-400">(Linguist, Cognitive Scientist, Political Thinker)</span>
              </h3>
              <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
            ...
            <div className="mb-8">
              <h3 className="text-2xl font-semibold font-serif text-black dark:text-white mb-2">
                Dominique Morgan <span className="text-lg font-normal text-zinc-600 dark:text-zinc-400">(Activist, Artist, Speaker)</span>
              </h3>
              <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
            ...
            <div className="mb-8">
              <h3 className="text-2xl font-semibold font-serif text-black dark:text-white mb-2">
                Ronny Chieng <span className="text-lg font-normal text-zinc-600 dark:text-zinc-400">(Actor and Comedian)</span>
              </h3>
              <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">

    ...
    <div className="flex min-h-screen flex-col items-center bg-zinc-50 font-sans dark:bg-black">
      <main className="flex w-full justify-center bg-white dark:bg-black pt-16">
        <section className="w-full max-w-5xl py-12 px-6 sm:px-16">
          ...
          <div className="mb-12">
            <h2 
              className="text-3xl font-bold font-serif text-black dark:text-white mb-6 cursor-pointer flex items-center gap-3 hover:text-zinc-700 dark:hover:text-zinc-300 transition-colors"
              onClick={() => toggleYear('2025')}
            >
              <motion.span 
                className="text-2xl inline-block w-6"

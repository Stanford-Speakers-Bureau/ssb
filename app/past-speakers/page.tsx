              ...
              {expandedYears['2025'] && (
                ...
                >
                  ...
                  <h3 className="text-xl sm:text-2xl font-semibold font-serif text-black dark:text-white mb-2">
                    Mark Rober <span className="text-base sm:text-lg font-normal text-zinc-600 dark:text-zinc-400 block sm:inline">(YouTube Educator, Former NASA & Apple Engineer)</span>
                  </h3>
                ...
                <div className="mb-8">
                  <h3 className="text-xl sm:text-2xl font-semibold font-serif text-black dark:text-white mb-2">
                    JoJo Siwa <span className="text-base sm:text-lg font-normal text-zinc-600 dark:text-zinc-400 block sm:inline">(Media Icon)</span>
                  </h3>
                  <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
                ...
                <div className="mb-8">
                  <h3 className="text-xl sm:text-2xl font-semibold font-serif text-black dark:text-white mb-2">
                    Peter Cuneo <span className="text-base sm:text-lg font-normal text-zinc-600 dark:text-zinc-400 block sm:inline">(Former Marvel CEO)</span>
                  </h3>
                  <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
                ...
                <div className="mb-8">
                  <h3 className="text-xl sm:text-2xl font-semibold font-serif text-black dark:text-white mb-2">
                    Mikey Day <span className="text-base sm:text-lg font-normal text-zinc-600 dark:text-zinc-400 block sm:inline">(SNL Cast Member)</span>
                  </h3>
                  <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
            ...
            <AnimatePresence initial={false}>
              {expandedYears['2024'] && (
                ...
                >
                  <div className="mb-8">
                  <h3 className="text-xl sm:text-2xl font-semibold font-serif text-black dark:text-white mb-2">
                    Alan Lightman <span className="text-base sm:text-lg font-normal text-zinc-600 dark:text-zinc-400 block sm:inline">(Physicist & Author)</span>
                  </h3>
                  <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
                ...
                <div className="mb-8">
                  <h3 className="text-xl sm:text-2xl font-semibold font-serif text-black dark:text-white mb-2">
                    Richard Sherman '10 <span className="text-base sm:text-lg font-normal text-zinc-600 dark:text-zinc-400 block sm:inline">(NFL Player)</span>
                  </h3>
                  <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
                ...
                <div className="mb-8">
                  <h3 className="text-xl sm:text-2xl font-semibold font-serif text-black dark:text-white mb-2">
                    John Green <span className="text-base sm:text-lg font-normal text-zinc-600 dark:text-zinc-400 block sm:inline">(Author & YouTube Educator)</span>
                  </h3>
                  <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
                ...
                <div className="mb-8">
                  <h3 className="text-xl sm:text-2xl font-semibold font-serif text-black dark:text-white mb-2">
                    Phil Hellmuth <span className="text-base sm:text-lg font-normal text-zinc-600 dark:text-zinc-400 block sm:inline">(17x World Poker Champion)</span>
                  </h3>
                  <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
            ...
            <AnimatePresence initial={false}>
              {expandedYears['2023'] && (
                ...
                >
                  <div className="mb-8">
                  <h3 className="text-xl sm:text-2xl font-semibold font-serif text-black dark:text-white mb-2">
                    Roxane Gay <span className="text-base sm:text-lg font-normal text-zinc-600 dark:text-zinc-400 block sm:inline">(Author)</span>
                  </h3>
                  <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
                ...
                <div className="mb-8">
                  <h3 className="text-xl sm:text-2xl font-semibold font-serif text-black dark:text-white mb-2">
                    Stuart Weitzman <span className="text-base sm:text-lg font-normal text-zinc-600 dark:text-zinc-400 block sm:inline">(Designer)</span>
                  </h3>
                  <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
                ...
                <div className="mb-8">
                  <h3 className="text-xl sm:text-2xl font-semibold font-serif text-black dark:text-white mb-2">
                    Kal Penn <span className="text-base sm:text-lg font-normal text-zinc-600 dark:text-zinc-400 block sm:inline">(Actor)</span>
                  </h3>
                  <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
                ...
                <div className="mb-8">
                  <h3 className="text-xl sm:text-2xl font-semibold font-serif text-black dark:text-white mb-2">
                    Sima Taparia <span className="text-base sm:text-lg font-normal text-zinc-600 dark:text-zinc-400 block sm:inline">(Netflix Personality)</span>
                  </h3>
                  <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
                ...
                <div className="mb-8">
                  <h3 className="text-xl sm:text-2xl font-semibold font-serif text-black dark:text-white mb-2">
                    Preacher Lawson <span className="text-base sm:text-lg font-normal text-zinc-600 dark:text-zinc-400 block sm:inline">(Stand-Up Comedian)</span>
                  </h3>
                  <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
            ...
            <AnimatePresence initial={false}>
              {expandedYears['2022'] && (
                ...
                >
                  <div className="mb-8">
                  <h3 className="text-xl sm:text-2xl font-semibold font-serif text-black dark:text-white mb-2">
                    Jennette McCurdy <span className="text-base sm:text-lg font-normal text-zinc-600 dark:text-zinc-400 block sm:inline">(Author and Actress)</span>
                  </h3>
                  <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
                ...
                <div className="mb-8">
                  <h3 className="text-xl sm:text-2xl font-semibold font-serif text-black dark:text-white mb-2">
                    Margaret Atwood <span className="text-base sm:text-lg font-normal text-zinc-600 dark:text-zinc-400 block sm:inline">(Writer)</span>
                  </h3>
                  <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
                ...
                <div className="mb-8">
                  <h3 className="text-xl sm:text-2xl font-semibold font-serif text-black dark:text-white mb-2">
                    Jimmy O. Yang <span className="text-base sm:text-lg font-normal text-zinc-600 dark:text-zinc-400 block sm:inline">(Stand-up Comedian)</span>
                  </h3>
                  <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
                ...
                <div className="mb-8">
                  <h3 className="text-xl sm:text-2xl font-semibold font-serif text-black dark:text-white mb-2">
                    Bill Nye <span className="text-base sm:text-lg font-normal text-zinc-600 dark:text-zinc-400 block sm:inline">(Scientist)</span>
                  </h3>
                  <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
                ...
                <div className="mb-8">
                  <h3 className="text-xl sm:text-2xl font-semibold font-serif text-black dark:text-white mb-2">
                    Sadiq Khan <span className="text-base sm:text-lg font-normal text-zinc-600 dark:text-zinc-400 block sm:inline">(Mayor of London)</span>
                  </h3>
                  <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
                ...
                <div className="mb-8">
                  <h3 className="text-xl sm:text-2xl font-semibold font-serif text-black dark:text-white mb-2">
                    Louise Glück <span className="text-base sm:text-lg font-normal text-zinc-600 dark:text-zinc-400 block sm:inline">(Poet)</span>
                  </h3>
                  <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
          ...
          <div className="mb-12">
            ...
            <AnimatePresence initial={false}>
              {expandedYears['2021'] && (
                ...
                <div className="mb-8">
                  <h3 className="text-xl sm:text-2xl font-semibold font-serif text-black dark:text-white mb-2">
                    Jaboukie Young-White <span className="text-base sm:text-lg font-normal text-zinc-600 dark:text-zinc-400 block sm:inline">(Comedian, Writer, and Filmmaker)</span>
                  </h3>
                  <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
                ...
                <div className="mb-8">
                  <h3 className="text-xl sm:text-2xl font-semibold font-serif text-black dark:text-white mb-2">
                    Sebastian Stan <span className="text-base sm:text-lg font-normal text-zinc-600 dark:text-zinc-400 block sm:inline">(Actor and Activist)</span>
                  </h3>
                  <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
                ...
                <div className="mb-8">
                  <h3 className="text-xl sm:text-2xl font-semibold font-serif text-black dark:text-white mb-2">
                    Jonathan Van Ness <span className="text-base sm:text-lg font-normal text-zinc-600 dark:text-zinc-400 block sm:inline">(Television Personality)</span>
                  </h3>
                  <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
                ...
                <div className="mb-8">
                  <h3 className="text-xl sm:text-2xl font-semibold font-serif text-black dark:text-white mb-2">
                    Noam Chomsky <span className="text-base sm:text-lg font-normal text-zinc-600 dark:text-zinc-400 block sm:inline">(Linguist, Cognitive Scientist, Political Thinker)</span>
                  </h3>
                  <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
                ...
                <div className="mb-8">
                  <h3 className="text-xl sm:text-2xl font-semibold font-serif text-black dark:text-white mb-2">
                    Dominique Morgan <span className="text-base sm:text-lg font-normal text-zinc-600 dark:text-zinc-400 block sm:inline">(Activist, Artist, Speaker)</span>
                  </h3>
                  <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
                ...
                <div className="mb-8">
                  <h3 className="text-xl sm:text-2xl font-semibold font-serif text-black dark:text-white mb-2">
                    Ronny Chieng <span className="text-base sm:text-lg font-normal text-zinc-600 dark:text-zinc-400 block sm:inline">(Actor and Comedian)</span>
                  </h3>
                  <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">

    ...
    <div className="flex min-h-screen flex-col items-center bg-zinc-50 font-sans dark:bg-black">
      <main className="flex w-full flex-1 justify-center bg-white dark:bg-black pt-16">
        <section className="w-full max-w-5xl flex flex-col py-12 px-6 sm:px-12 md:px-16">
          ...
          <div className="bg-zinc-50 dark:bg-zinc-900 rounded-lg p-8 shadow-sm border border-zinc-200 dark:border-zinc-800">
            <h2 className="text-2xl sm:text-3xl font-bold font-serif text-black dark:text-white mb-2">
              Malala Yousafzai
            </h2>
            <p className="text-base sm:text-lg text-zinc-600 dark:text-zinc-400 mb-6 italic">
              Nobel Peace Prize Laureate & Education Activist
            </p>
            
            <div className="space-y-3 mb-6">
              <div className="flex items-center gap-2">
                <svg className="w-5 h-5 text-[#A80D0C] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              >
                ...
                <p className="text-base text-zinc-700 dark:text-zinc-300 font-medium underline decoration-zinc-400 decoration-1 underline-offset-2">
                  CEMEX Auditorium
                </p>
              </a>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 rounded px-5 py-2.5 text-sm font-semibold text-white bg-[#A80D0C] shadow-md transition-all hover:bg-[#8B0A0A] hover:shadow-lg"
            >
